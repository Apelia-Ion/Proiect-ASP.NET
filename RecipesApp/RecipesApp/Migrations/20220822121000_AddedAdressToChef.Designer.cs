...
namespace RecipesApp.Migrations
{
    ...
    [Migration("20220822121000_AddedAdressToChef")]
    partial class AddedAdressToChef
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChefRecipe", b =>
                {
                    b.Property<string>("ChefsId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("RecipesId")
                        .HasColumnType("int");

                    b.HasKey("ChefsId", "RecipesId");
            ...
            modelBuilder.Entity("ChefRecipe", b =>
                {
                    b.HasOne("RecipesApp.Entities.Chef", null)
                        .WithMany()
                        .HasForeignKey("ChefsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecipesApp.Entities.Recipe", null)
                        .WithMany()
